...
\begin{itemize}
    ...
    \item \textbf{Sub-Objective 2: [Test / Validate / Analyze $\dots$]} - One sentence describing the second technical objective, such as experimentally validating performance, benchmarking against the state of the art, or analyzing the governing mechanisms and key performance limitations.
    \item \textbf{Sub-Objective 3: [Explore / Generalize / Pioneer $\dots$]} - One sentence describing the third technical objective, such as exploring new research directions, generalizing the resulting insights beyond the initial system or operating conditions, or pioneering a new capability, framework, or application.
\end{itemize}
